...
_FILE_PATTERN = 'Supervisely_Person_%s_*.tfrecord'

SPLITS_TO_SIZES = {'train': 5863, 'validation': 1200}
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
    ...
    items_to_handlers = {
        ...
        'mask': slim.tfexample_decoder.Image(image_key='mask/encoded', format_key='mask/format', channels=1)
    }
